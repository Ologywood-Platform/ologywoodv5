export const ENV = {
  ...
  baseUrl: process.env.BASE_URL || `https://${process.env.VITE_APP_ID || ''}.manus.space`,
  cookieSecret: process.env.JWT_SECRET ?? "",
  databaseUrl: process.env.DATABASE_URL ?? "",
  oAuthServerUrl: process.env.OAUTH_SERVER_URL ?? "",
  oAuthRedirectBaseUrl: process.env.VITE_OAUTH_REDIRECT_BASE_URL ?? "",
...
export const STRIPE_LIVE_WEBHOOK_SECRET = process.env.STRIPE_LIVE_WEBHOOK_SECRET;
