...
const pool = mysql.createPool({
  ...
  database: process.env.DATABASE_NAME || "ologywood",
...
async function seed() {
  try {
    console.log("🌱 Starting support data seed...");
    ...
    console.log(`✅ Seeded ${supportCategoriesData.length} categories`);
    ...
    console.log(`✅ Seeded ${knowledgeBaseArticlesData.length} articles`);

    console.log("\n✨ Support data seed completed successfully!");
    process.exit(0);
  } catch (error) {
