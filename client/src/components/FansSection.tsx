 ...
 * Paid tier: Shows full fan list with emails, export to CSV
 */

import { trpc } from "@/lib/trpc";
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card";
import { Button } from "@/components/ui/button";
import { Users, Lock, Download, Crown, Mail, UserCheck } from "lucide-react";
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-slate-900">
                      Unlock Your Fan Email List
                    </p>
                    <p className="text-xs text-muted-foreground mt-1">
                      Upgrade to a paid plan to access your fans' email addresses, export them as CSV, 
                      and send direct updates. Build a direct relationship with your audience.
                    </p>
                    <Button
                      size="sm"
