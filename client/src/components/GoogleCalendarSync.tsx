...
export function GoogleCalendarSync() {
  ...
  // Coming Soon state - shown when Google hasn't verified the app yet
  if (!GOOGLE_CALENDAR_VERIFIED) {
    return (
      <div className="bg-white border border-gray-200 rounded-lg p-6 opacity-80">
        <div className="flex items-start justify-between mb-3">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Connect your Google Calendar to automatically block off busy dates in your availability. This feature is being verified by Google and will be available shortly.
            </p>
          </div>
        </div>
        ...
        <div>
          <button
            disabled
            className="inline-flex items-center gap-2 px-4 py-2 bg-gray-100 border border-gray-200 rounded-lg text-sm font-medium text-gray-400 cursor-not-allowed"
          >
          ...
          <p className="text-xs text-gray-400 mt-2">
            Pending Google verification. Once approved, you'll be able to sync your calendar to automatically manage your availability.
          </p>
        </div>
      </div>
    );
