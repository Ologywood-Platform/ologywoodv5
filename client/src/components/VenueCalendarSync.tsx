...
export function VenueCalendarSync() {
  const [showUrl, setShowUrl] = useState(false);
  const [copied, setCopied] = useState(false);

  const { data, isLoading, error } = trpc.venue.getCalendarFeedUrl.useQuery();
      ...
      <div className="flex items-start justify-between mb-3">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Subscribe to your venue's booking calendar in Google Calendar, Apple Calendar, or Outlook.
