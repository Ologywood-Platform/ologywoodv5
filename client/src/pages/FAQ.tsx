...
export default function FAQ() {
  ...
  const faqs = [
    ...
    { q: 'How do contracts and e-signatures work?', a: 'When a booking is confirmed, a digital contract is generated with the agreed terms. Athlete contracts include versioned readiness protections, separated platform, processing, and representative fees, media rights, termination terms, and institutional/legal review language. Both parties sign electronically with drawn or typed signatures, verified with IP logging and timestamps. Templates do not certify eligibility or legal compliance. Available on the Professional plan.' },
    { q: 'What is a NIL Engagement Contract?', a: 'A versioned contract generated for athlete bookings. It covers the parties, services, compensation and separated fees, travel and logistics, security, facilities, media rights, athlete representations, optional proposed protections, cancellation, and signatures. Athletes can edit clauses before signing. It is a readiness template—not legal advice or a compliance certificate. Consult your institution and qualified sports counsel.' },
    ...
    { q: 'Does Ologywood certify NIL or NCAA compliance?', a: 'No. Ologywood provides private NIL readiness tools, versioned contract templates, separated fee records, and optional reporting reminders, but it is not an NCAA compliance office, athlete agent, or law firm. Athletes remain responsible for eligibility, institutional review, required disclosures, and legal advice.' },
